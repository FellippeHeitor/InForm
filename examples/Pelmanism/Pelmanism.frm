...
SUB __UI_LoadForm
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_Form, "Pelmanism", 842, 649, 0, 0, 0)
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "Pelmanism"
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 12)
    Control(__UI_NewID).ForeColor = _RGB32(169, 168, 168)
    Control(__UI_NewID).BackColor = _RGB32(0, 0, 0)
    Control(__UI_NewID).HasBorder = False

    __UI_NewID = __UI_NewControl(__UI_Type_Frame, "AudioFM", 106, 82, 720, 480, 0)
    __UI_RegisterResult = 0
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_RadioButton, "AudioOnRB", 80, 23, 16, 16, __UI_GetID("AudioFM"))
    __UI_RegisterResult = 0
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_RadioButton, "AudioOffRB", 80, 23, 16, 42, __UI_GetID("AudioFM"))
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "Audio Off"
    Control(__UI_NewID).HasBorder = False
    Control(__UI_NewID).CanHaveFocus = True

    __UI_NewID = __UI_NewControl(__UI_Type_Label, "BestScoreLB", 160, 84, 666, 40, 0)
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "Best Score:"
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 30)
    Control(__UI_NewID).ForeColor = _RGB32(172, 180, 16)
    Control(__UI_NewID).HasBorder = True
    Control(__UI_NewID).WordWrap = True
    Control(__UI_NewID).BorderSize = 1

    __UI_NewID = __UI_NewControl(__UI_Type_Label, "ScoreLB", 160, 56, 666, 200, 0)
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "Score:"
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 30)
    Control(__UI_NewID).ForeColor = _RGB32(240, 254, 25)
    Control(__UI_NewID).HasBorder = True
    Control(__UI_NewID).WordWrap = True
    Control(__UI_NewID).BorderSize = 1

    __UI_NewID = __UI_NewControl(__UI_Type_Label, "PelmanismLB", 150, 43, 80, 40, 0)
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "Pelmanism"
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_Label, "PairingsCompletedLB", 122, 70, 704, 350, 0)
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "Pairings Completed"
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 22)
    Control(__UI_NewID).ForeColor = _RGB32(230, 230, 230)
    Control(__UI_NewID).HasBorder = True
    Control(__UI_NewID).VAlign = __UI_Middle
    Control(__UI_NewID).WordWrap = True
    Control(__UI_NewID).BorderSize = 1

    __UI_NewID = __UI_NewControl(__UI_Type_Button, "ExitBT", 80, 23, 746, 610, 0)
    __UI_RegisterResult = 0
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_Button, "NewGameBT", 80, 23, 746, 576, 0)
    __UI_RegisterResult = 0
