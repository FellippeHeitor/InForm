...
SUB __UI_LoadForm
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_Form, "Lander_Inform2", 1200, 730, 0, 0, 0)
    ...
    __UI_RegisterResult = 0
    LoadImage Control(__UI_NewID), "left.png"
    Control(__UI_NewID).Stretch = True
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 16)
    Control(__UI_NewID).ForeColor = _RGB32(0, 45, 150)
    Control(__UI_NewID).HasBorder = False
    Control(__UI_NewID).CanHaveFocus = True

    __UI_NewID = __UI_NewControl(__UI_Type_Button, "bThrust", 200, 50, 500, 645, 0)
    __UI_RegisterResult = 0
    LoadImage Control(__UI_NewID), "thrust.png"
    Control(__UI_NewID).Stretch = True
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 16)
    Control(__UI_NewID).ForeColor = _RGB32(0, 45, 150)
    Control(__UI_NewID).HasBorder = False
    ...
    __UI_RegisterResult = 0
    LoadImage Control(__UI_NewID), "right.png"
    Control(__UI_NewID).Stretch = True
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 16)
    Control(__UI_NewID).ForeColor = _RGB32(0, 45, 150)
    Control(__UI_NewID).HasBorder = False
    ...
    __UI_RegisterResult = 0
    LoadImage Control(__UI_NewID), "restart.png"
    Control(__UI_NewID).Stretch = True
    Control(__UI_NewID).Font = SetFont("segoeui.ttf", 16)
    Control(__UI_NewID).ForeColor = _RGB32(0, 45, 150)
    Control(__UI_NewID).HasBorder = False
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_PictureBox, "pbScene", 1190, 600, 5, 5, 0)
    __UI_RegisterResult = 0
...
SUB __UI_AssignIDs
    Lander_Inform2 = __UI_GetID("Lander_Inform2")
